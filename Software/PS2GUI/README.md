# PS2GUI — a graphical (Easy-Setup style) PC110 system manager

> **Standalone repo:** https://github.com/ahmadexp/PS2GUI  (source + prebuilt binary).
> This folder mirrors it alongside the reverse-engineering notes.
